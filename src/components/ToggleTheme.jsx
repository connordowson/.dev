...
const ToggleTheme = () => {
  ...
  return (
    <button
      ...
      class="inline-flex justify-center rounded-lg border-none self-center bg-emerald-400 p-2 shadow cursor-pointer hover:bg-emerald-300 transition-colors"
      onClick={() => setTheme((theme) => (theme === "dark" ? "light" : "dark"))}
    >
      {theme() === "dark" ? (
        <svg
          class="h-4 w-4 dark:text-emerald-900 text-emerald-50"
          width="32"
          height="32"
          viewBox="0 0 24 24"
        >
